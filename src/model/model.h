...
namespace s21 {
/**
 * @brief Класс содержит методы, позволяющие производить
 * вычисления выражения представленные в строке и получать
 * результат с использованием обратной польской нотацией
 * 
 */
class Model {
 public:
 ...
 private:
  ...
  std::stack<Lexeme> numbers_;     // стэк для цифр
  std::stack<Lexeme> operations_;  // стэк для операторов
